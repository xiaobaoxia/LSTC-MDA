...
if __name__ == "__main__":
    ...
    parser.add_argument('--joint-dir',
                        # default=None,
                        default='work_dir/nw_ucla/SkateFormer_j_tconv_jmda_add_mixup', # 95.4741%
                        # default='work_dir/nw_ucla/SkateFormer_j_tconv_jmda_add_mixup_ablation', # 94.8276%
                        # default='work_dir/nw_ucla/SkateFormer_j_tconv_uniform_jmda_add_mixup', # 95.0431%
                        # default='work_dir/nw_ucla/SkateFormer_j',
                        help='Directory containing "epoch1_test_score.pkl" for joint eval results')
    parser.add_argument('--bone-dir',
                        # default=None,
                        default='work_dir/nw_ucla/SkateFormer_b_tconv_jmda_add_mixup',
                        # default='work_dir/nw_ucla/SkateFormer_b_tconv_jmda_add_mixup_ablation',
                        # default='work_dir/nw_ucla/SkateFormer_b',
                        help='Directory containing "epoch1_test_score.pkl" for bone eval results')
    parser.add_argument('--joint-motion-dir',
                        # default=None,
                        default='work_dir/nw_ucla/SkateFormer_jm_tconv_jmda_add_mixup',
                        # default='work_dir/nw_ucla/SkateFormer_jm_tconv_jmda_add_mixup_ablation',
                        # default='work_dir/nw_ucla/SkateFormer_jm',

                        )
    parser.add_argument('--bone-motion-dir',
                        # default=None,
                        default='work_dir/nw_ucla/SkateFormer_bm_tconv_jmda_add_mixup',
                        # default='work_dir/nw_ucla/SkateFormer_bm_tconv_jmda_add_mixup_ablation',
                        # default='work_dir/nw_ucla/SkateFormer_bm',
                        )
    ...
    if 'ntu60' in arg.dataset:
     ## ntu60
        arg.alpha = [1.6, 1.2, 0.8, 0.1]
    elif 'UCLA' in arg.dataset:
         # ucla
        arg.alpha = [0.8, 0.8, 0.3, 0.2] # proposed 97.2
        # arg.alpha = [1, 0.7, 0.7, 0.2] # ablation
        # arg.alpha = [1, 0, 0, 0] # uniform
        # arg.alpha = [1, 0, 0, 0] # 5uniform
        # arg.alpha = [1, 0, 0, 0] # tconv4
        # arg.alpha = [0.8, 0.8, 0.3, 0.4] # baseline
