...
def split_dataset(skes_joints, label, performer, setup, evaluation, save_path,camera):
    ...
    camera_train = camera[train_indices]
    camera_test = camera[test_indices]

    setup_train = setup[train_indices]
    setup_test = setup[test_indices]

    train_samples = skes_name[train_indices]
    test_samples = skes_name[test_indices]
    ...
    np.savez(save_name, x_train=train_x, y_train=train_y, x_test=test_x, y_test=test_y,
             camera_train=camera_train, camera_test=camera_test,setup_train=setup_train, setup_test=setup_test,
...
if __name__ == '__main__':
    ...
    for evaluation in evaluations:
        split_dataset(skes_joints, label, performer, setup, evaluation, save_path,camera)
