...
if __name__ == "__main__":
    ...
    parser.add_argument('--joint-dir',
                        default='work_dir/ntu120/csub/SkateFormer_j_tconv_jmda_add_mixup/',
                        # default='work_dir/ntu120/csub/SkateFormer_j/',
                        help='Directory containing "epoch1_test_score.pkl" for joint eval results')
    parser.add_argument('--bone-dir',
                        default='work_dir/ntu120/csub/SkateFormer_b_tconv_jmda_add_mixup',
                        # default='work_dir/ntu120/csub/SkateFormer_b',
                        help='Directory containing "epoch1_test_score.pkl" for bone eval results')
    parser.add_argument('--joint-motion-dir',
                        # default=None,
                        default='work_dir/ntu120/csub/SkateFormer_jm_tconv_jmda_add_mixup',
                        # default='work_dir/ntu120/csub/SkateFormer_jm',
                        )
    parser.add_argument('--bone-motion-dir',
                        # default=None,
                        # default='work_dir/ntu120/csub/SkateFormer_bm',
                        default='work_dir/ntu120/csub/SkateFormer_bm_tconv_jmda_add_mixup',
                        )
    ...
    if 'ntu' in arg.dataset:
        # arg.alpha = [1, 1.3, 0.3, 0.6] # baseline
        arg.alpha = [1.9, 1.2, 0.5, 0.1]#90.449
    ...
    correct_count = [0 for i in range(120)]
    label_count = [0 for i in range(120)]
    ...
    import json
    with open("acc_120cs_proposed.json", "w") as f:
        json.dump([correct_count[i] / label_count[i] for i in range(120)], f)
