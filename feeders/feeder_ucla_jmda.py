...
class Feeder(Dataset):
    def __init__(self, data_path, label_path, data_type='j', repeat=1, p=0.5,
        ...
        for index in range(len(self.data_dict)):
            info = self.data_dict[index]
            self.cam.append(int(info['file_name'].split('_')[-1][-2:]))
    ...
    def __getitem__(self, index):
        ...
        cam = self.cam[index % len(self.data_dict)]
        ...
        if self.train_val == 'train':
            ...
            center = value[0, 1, :]
            value = value - center
            scalerValue = self.rand_view_transform(value, agx, agy, s) # 数据增强,旋转拉伸
        ...
        return data, index_t, label, index, cam
