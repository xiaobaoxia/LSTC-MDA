...
if __name__ == "__main__":
    ...
    parser.add_argument('--joint-dir',
                        default='work_dir/ntu120/cset/SkateFormer_j_tconv_jmda_add_mixup/',
                        # default='work_dir/ntu120/cset/SkateFormer_j/',
                        help='Directory containing "epoch1_test_score.pkl" for joint eval results')
    parser.add_argument('--bone-dir',
                        default='work_dir/ntu120/cset/SkateFormer_b_tconv_jmda_add_mixup',
                        # default='work_dir/ntu120/cset/SkateFormer_b',
                        help='Directory containing "epoch1_test_score.pkl" for bone eval results')
    parser.add_argument('--joint-motion-dir',
                        # default=None,
                        default='./work_dir/ntu120/cset/SkateFormer_jm_tconv_jmda_add_mixup/',
                        # default='./work_dir/ntu120/cset/SkateFormer_jm',
                        )
    parser.add_argument('--bone-motion-dir',
                        # default=None,
                        default='./work_dir/ntu120/cset/SkateFormer_bm_tconv_jmda_add_mixup/',
                        # default='./work_dir/ntu120/cset/SkateFormer_bm',
                        )
    ...
    if 'ntu' in arg.dataset:
        arg.alpha = [1.4, 1.2, 0.5, 0.1] # proposed
        # arg.alpha = [0.6, 0.6, 0.2, 0.2] # baseline
