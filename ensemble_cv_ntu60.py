...
def softmax(x, axis=-1):
    x_max = np.max(x, axis=axis, keepdims=True)  # 防止指数爆炸
...
if __name__ == "__main__":
    ...
    if 'ntu60' in arg.dataset:
        arg.alpha = [0.6, 0.6, 0.6, 0.1] # 97.46 proposed
        # arg.alpha = [0.6, 0.6, 0.4, 0.4] # 97.31 Skateformer
