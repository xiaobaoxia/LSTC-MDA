...
class PatchMergingTconv(nn.Module):
    def __init__(self, dim_in, dim_out, T=64,kernel_size=7, stride=2, dilation=1,num_points=48):
        ...
        # 987840 params 0.94207763671875 M
        # w=192,96 b=192
        # 737280+ 576 = 737856
        self.conv2 = nn.Conv2d(dim_in, dim_out, kernel_size=(8, 1))

        self.zeros_ = torch.zeros(dim_out, dim_in, T-5, 1)
    ...
    def forward(self, x):
        ...
        conv2_weight = torch.cat([self.conv2.weight[:, :, :4], self.zeros, self.conv2.weight[:, :, -4:]], dim=2)
